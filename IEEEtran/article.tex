...
\begin{figure*}[!t]
\centering
\subfloat[Example of calling another diagram]{\includegraphics[width=0.25\textwidth]{methodOne}%
\label{fig:methodOne}}
\hfil
\subfloat[Example of recursion]{\includegraphics[width=0.5\textwidth]{methodTwo}%
\label{fig:methodTwo}}
...
\begin{figure*}[!t]
	\centering
	\subfloat[Graph of grounding size per step]{\includegraphics[width=0.5\textwidth]{grounding}%
		\label{fig:grounding}}
	\hfil
	\subfloat[Graph of cumulative execution time per step]{\includegraphics[width=0.5\textwidth]{ms}}%
		\label{fig:ms}
	\caption{Graphs for grounding size and cumulative execution time}
	\label{fig:grounding-ms}
\end{figure*}
