...
\section{Het uivoeren van gecombineerde fragmenten}\label{sec:combined-fragment}
...
\begin{algorithm}
	\KwIn{\textit{fragment : gecombineerd fragment; mapPaar : bericht $\rightarrow$ verzameling van \{bericht $\rightarrow$ string\}; transitieVoorwaarde : string}}
