...
\begin{enumerate}
	\item \onlineitem{Theorie gegeneerd uit diagram \ref{fig:seq-diagram-game} volgens de regels in secties \ref{sec:sd-voc} tot en met \ref{sec:combined-fragment}}{https://pastebin.com/WGQjr2bv}
