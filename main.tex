...
\setup{filingcard,
	translatedtitle={TBD},
	udc=681.3,
	shortabstract={	UML is een grafische taal die een aantal soorten diagrammen aanbiedt om een mogelijk ontwerp voor een gewenst softwaresysteem op te stellen. Als de ontwerper echter een groot aantal diagrammen opstelt en de diagrammen een zekere omvang bereiken, is het makkelijk om het overzicht te verliezen. Wij richten ons op klassediagrammen en sequentiediagrammen. We bekijken voorstellen in de literatuur om deze soorten diagrammen voor te stellen in logica en om die voorstellingen te gebruiken om verificatie van consistentie en de aanwezigheid van gewenste eigenschappen te controleren. Daarna beschrijven we ons proces om klassediagrammen en bijhorende sequentiediagrammen te vertalen naar FO($\cdot$), een uitbreiding van eerste-orde-predicatenlogica. We tonen hoe we de resulterende theorie kunnen gebruiken om consistentie van het klassediagram te controleren en om bepaalde kwaliteitsgebreken op te sporen. Verder tonen we ook hoe we de vertaling van een stel sequentiediagrammen in een FO($\cdot$)-theorie gebruiken om simulaties van het voorgestelde systeem uit te voeren en om te verifi\"eren of diagrammen voldoen aan specifieke vooropgestelde vereisten. We geven ook een aanzet om declaratieve elementen te integreren in de ontwerptaal voor sequentiediagrammen om zo breder toepasbare verificaties toe te laten. }}
